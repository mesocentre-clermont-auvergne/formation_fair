...
\end{itemize}
\end{minipage}
\onslide<3->{\centering\includegraphics[width=0.5\textwidth]{images/conda_env_detail.pdf}\blfootnote{Bioconda: sustainable and comprehensive software distribution for the life sciences \textit{Grüning et al.}, Nature methods, 2018. DOI 10.1038/s41592-018-0046-7}}
\end{frame}
