...
\centering{
\onslide<1->{\includegraphics[width=0.17\textwidth]{images/schema_soumission_fair.pdf}}
\onslide<2->{\includegraphics[width=0.4\textwidth]{images/review.jpg}}
\onslide<3->{\includegraphics[width=0.17\textwidth]{images/schema_soumission_fair_echec.pdf}}}
\end{frame}
\begin{frame}{A classic use case}
...
\onslide<1->{\includegraphics[width=0.25\textwidth]{images/conda_env_1.pdf}}
\onslide<2->{\includegraphics[width=0.25\textwidth]{images/conda_env_2.pdf}}
\onslide<3->{\includegraphics[width=0.25\textwidth]{images/conda_env_2.pdf}}
\onslide<4->{\includegraphics[width=0.25\textwidth]{images/conda_env_4.pdf}}
\end{frame}
