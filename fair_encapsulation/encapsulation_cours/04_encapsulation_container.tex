...
\onslide<3-4>{\includegraphics[width=4cm, height=1cm]{images/docker_env_1.pdf}}
\end{textblock*}

\begin{textblock*}{10cm}(6cm,4.5cm) % {block width} (coords)
\onslide<4-4>{\includegraphics[width=4cm, height=3.7cm]{images/docker_env_2.pdf}} 
\end{textblock*}
\end{frame}
...
\only<1>{\includegraphics[width=\textwidth]{images/docker_hub.png}}
\only<2>{\includegraphics[width=\textwidth]{images/singularity_hub.png}}
\begin{itemize}[<3>]
