...
\item<2-3> \hyperlink{https://docs.conda.io/en/latest/miniconda.html}{Miniconda}
	...
	\end{itemize}
\item<3> \hyperlink{https://docs.conda.io/projects/conda/en/latest/index.html}{Conda} \includegraphics[width=0.1\textwidth]{conda_logo.pdf} 
	\begin{itemize}[<4->]
...
\end{itemize}
\end{minipage}
\onslide<3->{\centering\includegraphics[width=0.5\textwidth]{conda_env_detail.pdf}\blfootnote{Bioconda: sustainable and comprehensive software distribution for the life sciences \textit{Grüning et al.}, Nature methods, 2018. DOI 10.1038/s41592-018-0046-7}}
\end{frame}
...
\end{itemize}}
\only<2>{\centering\includegraphics[width=0.7\textwidth]{conda_use.pdf}
