...
\begin{itemize}[<+->]
	...
	\item Named containers: \includegraphics[scale=0.03]{docker_logo2.png} or \includegraphics[scale=0.1]{singularity_logo.pdf}
...
\onslide<3-4>{\includegraphics[width=4cm, height=1cm]{docker_env_1.pdf}}
\end{textblock*}

\begin{textblock*}{10cm}(6cm,4.5cm) % {block width} (coords)
\onslide<4-4>{\includegraphics[width=4cm, height=3.7cm]{docker_env_2.pdf}} 
\end{textblock*}
\end{frame}
...
\only<1>{\includegraphics[width=\textwidth]{docker_hub.png}}
\only<2>{\includegraphics[width=\textwidth]{singularity_hub.png}}
\begin{itemize}[<3>]
