...
\end{columns}
\centering{
\onslide<1-3>{\includegraphics[width=0.3\textwidth]{VM_env_1.pdf}}
\onslide<3-4>{\includegraphics[width=0.3\textwidth]{VM_env_2.pdf}}
}
\end{frame}
\begin{frame}
\centering{\includegraphics[width=0.8\textwidth]{virtualbox-main.png}}
\end{frame}
