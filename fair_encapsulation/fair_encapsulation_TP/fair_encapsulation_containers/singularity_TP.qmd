...
author: "Philippe Ruiz - Pierre Marin - Aubi"
format: html
editor: visual
---
...
Une nouvelle image est créée avec le tag de l'ancienne. On peut également modifier le tag (numéro de version ex: v3.0). Dans ce cas `Docker` construira une nouvelle image tout er concervant l'ancienne.
...
-   En executant un script en arrière plan qui retourne directement le resultat :
Voici un exemple utilisant `fastqc` :
...
Les resultats sont disponible dans le répertoire de travail.
