...
\centering\includegraphics[page=44,scale=0.55]{fair_data_introduction.pdf}
\end{frame}
% l'augmentation des bases de données internationales
\begin{frame}{Focus on the data}
\centering\includegraphics[page=18,scale=0.55]{fair_data_introduction.pdf}
\end{frame}
