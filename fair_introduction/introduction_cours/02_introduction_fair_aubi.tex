...
\centering{Then... \\
Must have good practice on ressource use ?}

\end{frame}
\begin{frame}
\only<1>{\includegraphics[width=\textwidth]{images/Efficiency_of_jobs_on_used_RAM_per_account_1.pdf}}
\only<2>{\includegraphics[width=\textwidth]{images/Efficiency_of_jobs_on_used_CPU_per_account_3.pdf}}
\end{frame}
