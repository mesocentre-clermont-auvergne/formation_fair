...
\begin{textblock*}{10cm}(1cm,3cm) % {block width} (coords)
  \includegraphics[width=7cm,height=5cm]{cahierlabo.png}
 \end{textblock*}
 \begin{textblock*}{10cm}(8cm,3cm) % {block width} (coords)
  \includegraphics[width=7cm,height=5cm]{cahier2.pdf}
 \end{textblock*}}
\end{frame}
...
\only<2>{\includegraphics[width=0.2\textwidth]{elabftw-logo.png}}
\only<3>{\includegraphics[width=0.9\textwidth]{elabftw1.jpg}}
\only<4>{\includegraphics[width=0.9\textwidth]{elabftw2.jpg}}
...
\begin{frame}{Electronic version}
\only<1>{\centering\includegraphics[width=10cm,height=7cm]{gt_eln.png}}
\only<2>{\centering\includegraphics[width=10cm,height=7cm]{gt_eln_temp.png}}
\end{frame}
